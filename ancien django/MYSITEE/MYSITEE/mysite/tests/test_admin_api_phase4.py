...
class ClassesAndTeachersViewTests(TestCase):
    ...
    def test_get_classes_and_teachers_success(self):
        ...
        response = self.client.get('/api/admin/classes-teachers/', format='json')
    ...
    def test_cache_is_used(self):
        ...
        response1 = self.client.get('/api/admin/classes-teachers/', format='json')
        ...
        response2 = self.client.get('/api/admin/classes-teachers/', format='json')
