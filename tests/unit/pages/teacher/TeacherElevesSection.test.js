...
describe('init — chargement liste élèves', () => {
    ...
    it('utilise le cache si disponible', async () => {
        ...
        supabaseAdmin.getMyStudents.mockResolvedValue({ data: cached });

        await init();

        // Le code utilise _toujours_ getMyStudents() pour avoir des données fraîches
        // puis met en cache (apiCache.set)
