...
export async function openAuthModal(page) {
    // NavManager injecte un bouton avec data-action, text content "تسجيل الدخول", ou onclick showLoginForm
    const loginBtn = page.locator(
        '[onclick*="showLoginForm"], button:has-text("تسجيل الدخول"), .nav-login-btn'
    );
