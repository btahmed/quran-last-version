...
function createTableRow(item) {
    return `
        <tr>
            ...
            <td>
                <button class="btn btn-sm btn-primary" onclick="QuranReview.markAsReviewed(${item.id})" aria-label="تسجيل المراجعة" title="تسجيل المراجعة">
                    ✓ مراجعة
                </button>
                <button class="btn btn-sm btn-success" onclick="QuranReview.playSurahAudio(${item.surahId})" aria-label="استماع للسورة" title="استماع للسورة">
                    🎵 استماع
                </button>
                <button class="btn btn-sm btn-secondary" onclick="QuranReview.openTarteel(${item.surahId}, ${item.fromAyah}, ${item.toAyah})" aria-label="فتح في تطبيق ترتيل" title="فتح في تطبيق ترتيل">
                    🎧 ترتيل
                </button>
                <button class="btn btn-sm btn-danger" onclick="QuranReview.deleteItem(${item.id})" aria-label="حذف العنصر" title="حذف العنصر">
                    حذف
                </button>
            </td>
        </tr>
